    ...
    $("a").click(function (event) {
        ...
        if ($(this).children(".square").length > 0) {
            ...
            if ($("#yourboard").attr("data-turn") == "true") {
                ...
                if (!square.hasClass("hit") && !square.hasClass("boatHit") && !square.hasClass("boatDestroied")) {
                    ...
                    $.get(url, function (data) {
                        ...
                        if (data.result != undefined) {
                            ...
                            else if (data.boatDestroied) {
                                    square.addClass("boatDestroied");
                            }
                            else {
                                square.addClass("hit");
                            }
    ...
    function UpdateBoards(boards, playerId) {
        ...
        $.each(boards, function (key, updateBoard) {
            ...
            $.each(updateBoard, function (key, updateSquare) {
                ...
                if ((square.hasClass("boatHit") || (!square.hasClass("hit") && !square.hasClass("boatHit"))) && updateSquare.boatDestroied) {
                    square.addClass("boatDestroied");
                }
                ...
                if (!square.hasClass("hit") && !square.hasClass("boatHit") && !square.hasClass("boatDestroied")) {
                    ...
                    else if (updateSquare.boatDestroied) {
                        square.addClass("boatDestroied");
                    }
